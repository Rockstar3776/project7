...
scaler_path = os.path.join("pipeline_scaler.pkl")
scaler = joblib.load(scaler_path)
encod_path = os.path.join("pipeline_encod.pkl")
...
data_test = pd.read_csv("data/data_test.csv").set_index(keys=["SK_ID_CURR"])
